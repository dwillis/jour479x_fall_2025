---
title: "NCAA Women's Basketball Coaching Histories: Standardization"
---
...
canonical_positions <- tribble(
  ...
  "Assistant Head Coach", "Assistant to head coach role", 3,
...
position_roles_long <- positions_final |>
  ...
  mutate(role_standardized = sapply(role_components, standardize_position_title))
...
# Write to file
write(output_json, "coaching_histories_standardized.json")
...
- `coaching_histories_standardized.json` - Standardized dataset with originals preserved
