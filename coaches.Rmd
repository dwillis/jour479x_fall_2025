...
# Question for students: How many unique standardized titles exist for these variations?
# Answer: Should be 1 ("Head Coach")
```
...
# Students should write code here to find top 3 positions
# Solution:
top_3_positions <- positions_standardized |>
  count(position_title_standardized, sort = TRUE) |>
  head(3)

cat("Top 3 standardized positions:\n")
print(top_3_positions)

# Question: What are the top 3 positions and approximately what percentage
# of total positions does each represent?
```
...
# Question: Are titles like "Assistant Coach/Recruiting Coordinator" and
...
# Question: Why is this reduction important for data analysis?
# Answer: It allows us to group similar positions together and get more
# meaningful counts and analyses.
```
...
```{r verify-compound}
# Students should identify compound roles
...
# Question: What's an example of a compound role and what are its components?
```
...
# Should any of these be added to our standardization function?
```
...
career_path <- positions_standardized |>
  ...
  select(name, position_college, position_title_standardized,
         position_start, position_end)

cat("Career progression for:", coach_with_progression, "\n")
print(career_path, n = Inf)

# Question: How does standardization help us understand career progression?
# Answer: It makes it easier to see movement between role types (e.g.,
# Assistant Coach -> Associate Head Coach -> Head Coach)
```
